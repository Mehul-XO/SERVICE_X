...
export default function Calendar() {
    ...
    const date = selectDate.format("YYYY-MM-DD"); // Format the selected date
                                ...
                                >
                                    <h1
                                        className={cn(
                                            ...
                                            selectDate.format("YYYY-MM-DD") === date.format("YYYY-MM-DD")
                                                ? "bg-black text-white"
                                                : "",
                                            "h-10 w-10 rounded-full grid place-content-center hover:bg-black hover:text-white transition-all cursor-pointer select-none"
                                        )}
                                        onClick={() => {
                                            setSelectDate(date); // Update selected date
                                            setDisplay(true);
                                        }}
                                    >
                                        {date.date()}
